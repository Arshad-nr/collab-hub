          ...
          <table mat-table [dataSource]="users" style="width:100%;">
            ...
            <ng-container matColumnDef="skills">
              ...
              <td mat-cell *matCellDef="let u" class="mat-column-skills" style="padding: 12px 16px;">
                <div class="chip-list">
                  <mat-chip *ngFor="let s of u.skills?.slice(0, 3)" class="skill-chip">{{ s }}</mat-chip>
                  <span *ngIf="u.skills?.length > 3" style="font-size:11px; color:#d4af37; font-style:italic;">+{{ u.skills.length - 3 }}</span>
                </div>
              </td>
            </ng-container>
